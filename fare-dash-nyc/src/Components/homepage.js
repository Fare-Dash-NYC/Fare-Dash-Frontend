    ...
    <div>
      <div className="top-container">
        <img
          className="bg-img"
          alt=""
          src="https://brooklyneagle.com/wp-content/uploads/2021/03/AP17172784995527.jpg"
        />
      ...
      <div className="facts">
        <div className="facts-text">
          <p>
            92% of the 481 fare evasion arrests in the fourth quarter of 2019
            were of non-whi te riders; 60% were black. Data like that led New
            York Attorney General Letitia James to announce a probe of racial
            disparities in fare evasion stops.{" "}
          </p>
        </div>
        <div className="facts-text">
          <p>
            ...
            defenders, a pretty good sign they are struggling to make ends meet.
        ...
        <div className="facts-text">
          ...
          <p>
            ...
            problems playing out at the turnstile. They do not make transit more
            affordable. They do not make it easier for riders to pay. They do
            not reduce police bias, but rather enable.
          </p>
        </div>
      </div>
      <div className="stats">
