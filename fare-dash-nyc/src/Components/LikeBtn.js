...
function NotThere() {
  ...
  return (
    <>
      <h3 onClick={()=> setLike((prevLike) => !prevLike)}>{like? <i class="fa-solid fa-thumbs-up" style={{color: "brown"}}></i> : <i class="fa-regular fa-thumbs-up" style={{color: "white", cursor: "cursor-pointer"}}></i>}</h3>
